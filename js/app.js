...
document.addEventListener('DOMContentLoaded', async () => {
    // --- 🕵️‍♂️ BLOQUE DE RASTREO DE DATOS ---
    ...
    if (!rawData) {
        ...
        if (fallbackData) {
            console.info("💡 CONSEJO DE RASTREO: Tus datos están guardados bajo la clave plana 'financiero_state', pero el código los está buscando con sufijo de usuario.");
        }
    } else {
        try {
            ...
            console.error("❌ Error crítico: Los datos en localStorage están corruptos o mal formateados y no se pueden parsear:", err);
        }
    }
    console.log("---------------------------------------");
